...
const HeroSection = () => {
  return (
    <div className="flex flex-col items-center max-w-5xl mb-64 relative z-[2]">
      <h1 className="text-[60px] text-center leading-[5rem] font-semibold">
      ...
      <p className="text-center mt-[2.3rem] mb-16 text-[20px] max-w-4xl">
        Expand your reach, refine your campaigns, and build lasting partnerships
        with tools designed to save you time and deliver results — all in one
        seamless platform.
      </p>
